...
: ${AMENT_CURRENT_PREFIX:="/home/shaurya/bot_ws/install/bot_localization"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/bot_localization/environment/pythonpath.sh"
